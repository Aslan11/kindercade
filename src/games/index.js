...
export const SHELVES = [
  { subject: 'math', title: 'Numbers', emoji: '🔢', color: '#ff8a4c', color2: '#ffc93c' },
  { subject: 'spelling', title: 'Words', emoji: '🔤', color: '#4cc9f0', color2: '#7b8cff' },
  { subject: 'puzzle', title: 'Puzzles', emoji: '🧩', color: '#9b6cff', color2: '#ff8fd0' },
];
